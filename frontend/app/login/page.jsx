...
import { Briefcase, KeyRound, Mail, Loader2, ArrowRight } from 'lucide-react';
      ...
      <div className="hidden lg:flex lg:col-span-5 relative bg-indigo-600 overflow-hidden flex-col justify-between p-12 text-white">
        ...
        <div className="relative z-10 space-y-6">
          ...
          <p className="text-indigo-100 max-w-sm leading-relaxed text-sm">
            Access thousands of active job opportunities, customize your professional profile, and connect directly with hiring managers.
          </p>
        </div>
      ...
      <div className="lg:col-span-7 flex items-center justify-center p-8 sm:p-12 md:p-16">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center lg:text-left">
            <h1 className="text-3xl font-extrabold text-slate-900 dark:text-slate-100">Welcome Back</h1>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full py-3 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-semibold text-sm flex items-center justify-center gap-2 transition-all shadow-md shadow-indigo-100 dark:shadow-none disabled:opacity-75 disabled:pointer-events-none"
            >
              {submitting ? (
                <>
